<?php
add_shortcode('learning_style_test_series', 'learning_style_test_series');
function learning_style_test_series()
{
	global $wpdb;
	$prefix = $wpdb->prefix;
	...
	<div class="tab-content card pt-5" id="myTabContentMD">
		<div class="tab-pane fade" id="home-md" role="tabpanel" aria-labelledby="home-tab-md">
	  	...
	  	<div class="tab-pane fade show active" id="learning-style" role="tabpanel" aria-labelledby="learning-style-tab-md">
	    	<?php
			...
			{
				echo "Please Complete Multiple Intellegence Assessment quiz";
			}
			?>
	  	</div>
