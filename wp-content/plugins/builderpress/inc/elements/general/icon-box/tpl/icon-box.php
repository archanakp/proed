...
$style_color_layout = !empty($params['style_color_layout']) ? $params['style_color_layout'] : '';
...
?>
<div class="bp-element bp-element-icon-box <?php echo esc_attr($class_layout); ?> <?php echo esc_attr($icon_size); ?> <?php echo esc_attr($class_line); ?> <?php echo is_plugin_active('js_composer/js_composer.php') ? vc_shortcode_custom_css_class( $bp_css ) : '';?> <?php echo esc_attr( $layout ); ?> <?php echo esc_attr( $el_class ); ?> <?php echo esc_attr( $icon_style ); ?> <?php echo esc_attr($style_color_layout); ?>" <?php echo $el_id ? "id='" . esc_attr( $el_id ) . "'" : '' ?>  <?php echo $data_tablet;?> <?php echo $data_mobile;?>>
