...
WatuPRO.submitResult = function(e) {
	...
	if(!WatuPRO.forceSubmit) 
	{
		...
		{		
			...
			{
				missed = 1;	
				jQuery("#questionWrap-"+i).css("border-radius","5");
				jQuery("#questionWrap-"+i).css("background-color","rgb(241 47 41)");
			}
			else
			{
				// jQuery('html, body').animate({
			 	...
			 	//    }, 2000);
			    if(WatuPRO.exam_id == 6)
			    {
			    	jQuery("#home-tab-md").css("background-color","#d9534f");
			    	jQuery("#home-tab-md li a::before").css("background-color","#d9534f");
			    	jQuery("#home-tab-md li a::after").css("background-color","#d9534f");
			    }
			    if(WatuPRO.exam_id == 7)
			    {
			    	jQuery("#profile-tab-md").css("background-color","#d9534f");
			    	jQuery("#profile-tab-md li a::before").css("background-color","#d9534f");
			    	jQuery("#profile-tab-md li a::after").css("background-color","#d9534f");
			    }
			    if(WatuPRO.exam_id == 8)
			    {
			    	jQuery("#contact-tab-md").css("background-color","#d9534f");
			    	jQuery("#contact-tab-md li a::before").css("background-color","#d9534f");
			    	jQuery("#contact-tab-md li a::after").css("background-color","#d9534f");
			    }
			    if(WatuPRO.exam_id == 9)
			    {
			    	jQuery("#multiple-intellegence-tab-md").css("background-color","#d9534f");
			    	jQuery("#multiple-intellegence-tab-md li a::before").css("background-color","#d9534f");
			    	jQuery("#multiple-intellegence-tab-md li a::after").css("background-color","#d9534f");
			    }
			    if(WatuPRO.exam_id == 10)
			    {
			    	jQuery("#learning-style-tab-md").css("background-color","#d9534f");
			    	jQuery("#learning-style-tab-md li a::before").css("background-color","#d9534f");
			    	jQuery("#learning-style-tab-md li a::after").css("background-color","#d9534f");
			    }
			    jQuery("#question-"+i).css("background-color","rgb(248 248 248)");
			}
		}  
		if(missed == 1)
		{
...
WatuPRO.initWatu = function() {	
	...
	{
		var q_value = jQuery(this).val();
		WatuPRO.saveResult_yes(q_value);
	});
} // end init()
...
WatuPRO.saveResult_yes = function(e) {
	data = {'action' : 'watupro_store_all', 'question_ids' : this.qArr, "exam_id": this.exam_id, 
		'watupro_questions': jQuery('#quiz-'+this.exam_id+' input[name=watupro_questions]').val(),
		'current_question' : this.current_question};
	data=this.completeData(data);
