...
function watupro_screen_reader_text($class, $open_end = false) {
	...
	if($text == 'correct')
	{
		$data = "background-color:green; margin-left: 25px; border-radius:5px; color:#ffffff; padding: 5px;";
	}
	else
	{
		$data = "background-color:red; margin-left: 25px; border-radius:5px; color: #ffffff; padding: 5px;";
	}
	return '<span class="watupro-screen-reader'.$open_end_class.'" style="'.$data.'">' . $text . '</span>';
}
