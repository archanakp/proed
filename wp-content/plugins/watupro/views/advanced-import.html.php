	...
	<form method="post" enctype="multipart/form-data">
		<div class="inside watupro">
			...
			<div id="csvOptions" style='display:<?php echo (!empty($_POST['import_format']) and $_POST['import_format'] == 'aiken') ? 'none' : 'block'?>'>
				...
				<p><?php _e('If you have problems importing files with MathJax or other LaTeX expressions, please', 'watupro')?> <input type="checkbox" name="latex_problems" value="1"> <?php _e('check this checkbox and try again.', 'watupro')?></p></div>
