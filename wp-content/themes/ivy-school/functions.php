...
function archos_add_cpt() {

     $labels = array(

            'name' => __('Manage University', 'vee-core'),

            'singular_name' => __('University', 'vee-core'),

            'add_new' => __('Add New University', 'vee-core'),

            'add_new_item' => __('Add New University', 'vee-core'),

            'edit_item' => __('Edit University', 'vee-core'),

            'new_item' => __('All University', 'vee-core'),

            'view_item' => __('View University', 'vee-core'),

            'search_items' => __('Search University', 'vee-core'),

            'not_found' =>  __('University not found', 'vee-core'),

            'not_found_in_trash' => __('University', 'vee-core'),

            'parent_item_colon' => '',

            'menu_name' => __('University', 'vee-core')
    ...
    add_action('init', 'archos_add_cpt', 100);

    function chit_add_news_tax() {
        $labels = array (
            'name' => __( 'University Category', 'vee-core' ),
            'singluar_name' => __( 'University Category', 'vee-core' ),
            'search_items' => __( 'Search University Category', 'vee-core' ),
            'all_items' => __('All University', 'vee-core'),
            'parent_item' => __('Parent University', 'vee-core'),
            'parent_item_colon' => __('Parent University:', 'vee-core'),
            'edit_item' => __('Edit University', 'vee-core'),
            'update_item' => __('Update University', 'vee-core'),
            'add_new_item' => __('Add new University', 'vee-core'),
            'new_item_name' => __('New University', 'vee-core'),
            'menu_name' => __( 'Categories', 'vee-core' )
        );
        register_taxonomy( 'university-categories', array('university'), array (
                    'labels' => $labels,
                    'hierarchical' => true,
                    'show_ui' => true,
    ...
    add_action('init', 'chit_add_news_tax', 10);
...
function wpse66093_no_admin_access()
{
    ...
    if (current_user_can( 'student' ) || current_user_can( 'subscriber' ))
    {
